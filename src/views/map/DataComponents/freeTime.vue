<template>
  <div
    :class="['free-wrap', {edit: operationStatus === 'edit', checked: checked}]"
    @click="clickWrap"
  >
    <div class="item1">
      <div class="header">
...
import BarChart from './freeTimeComponent/barChart'
import {postSpareRateRanking} from '@/api/report'
...
export default {
  ...
  methods: {
    getData() {
      postSpareRateRanking({...this.params})
        .then(res => {
