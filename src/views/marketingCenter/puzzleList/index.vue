        ...
        <el-col :span="20">
          ...
          >
            ...
            <el-form-item label="互动状态">
              ...
              >
                <el-option
                  v-for="item in interactionStatusOptions"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          >
            <template slot-scope="scope">
              <p :class="['class-' + scope.row.status]">
                {{ getLable(scope.row.status, interactionStatusOptions) }}
              </p>
            </template>
          </el-table-column>
          <el-table-column
...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      queryInteractionPage(this.searchForm).then(res => {
        const data = res.body || {}
